...
// airanman
// lab5
// inputs numbered options to write a letter
// error 1: There is a logic error of the 'if' statement 
//          testing the proper range of sentenceCode,
//          it should be '> MaxCode' not '>=', since
//          MaxCode is initialized as 5.
// error 2: In the weatherModifier method, there is logic
//          error there being a semicolon after
//          'if(m == 2)', assigning word to 'foggy' even if
//          m == 1.
// error 3: There is a logic error in the if statement for 
//          when SentenceCode equals 5, where there is a
//          misplaced semicolon after an 'else' statement.
